...
const kSliderActiveTrackColor = Color(0xCCEB1555);
const kSliderInactiveTrackColor = Color(0xCC8D8E98);
...
const kBMIInterpretationTextStyle = TextStyle(fontSize: 22.0);
